...
#./gradlew run -Pargs="bugger.properties src/test/resources/http_jms_services_mapping.json" 
...
./gradlew bugger -Pargs="bugger.properties src/test/resources/http_jms_services_mapping.json"
./gradlew bugger -Pargs="bugger.properties src/test/resources/http_jms_services_mapping.json"
exit
