...
public class TransitionMappingsCodecTest {
    ...
    public void testEncodeDecode() {
        ...
        original.register(new TransitionMapping("WELCOME", "selectIndividual",
                "INDIVIDUAL"));
        ...
        original.register(new TransitionMapping("WELCOME", "selectOrg",
                "ORGANIZATION"));
        original.register(new TransitionMapping("ORGANIZATION", "saveProfile",
                "FINANCIAL_EXPERIENCE"));
        original.register(new TransitionMapping("FINANCIAL_EXPERIENCE",
        ...
        //
        original.register(new TransitionMapping("WELCOME", "selectIRA", "IRA"));
        ...
        TransitionMappings copy = TransitionMappingsCodec
                .decode(TransitionMappingsCodec.encode(original));
        assertEquals(original.getTransitions().size(), copy.getTransitions()
                .size());
